      ...
      <div className="w-full max-w-[1000px] flex flex-col md:flex-row gap-16 items-center">
        ...
        <div className="w-full max-w-[480px]">
          <div className="bg-[#111D2E] rounded-xl overflow-hidden border border-white/10 shadow-2xl">
            ...
            <pre className="p-6 text-[14px] leading-[20px] font-mono overflow-x-auto">
              <code className="text-[#E6E6E6]">
                ...
                {'  '}apiKey: <span className="text-[#A5D6FF]">'sk_test_9f8e7d6c5b4a32915b4a32915b4a3291'</span><br/>
                {'}'});<br/><br/>
          ...
          <div className="flex flex-wrap items-center gap-6 mt-6 pl-2">
            <a href="https://docs.solidus.network" target="_blank" rel="noopener noreferrer" className="text-[12px] font-medium text-cyan hover:underline flex items-center gap-1">View full SDK docs <ArrowRight className="w-3 h-3" /></a>
            <a href="https://github.com/solidusnetwork/sdk" target="_blank" rel="noopener noreferrer" className="text-[12px] font-medium text-cyan hover:underline flex items-center gap-1">Python SDK <ArrowRight className="w-3 h-3" /></a>
            <a href="https://github.com/solidusnetwork/sdk" target="_blank" rel="noopener noreferrer" className="text-[12px] font-medium text-cyan hover:underline flex items-center gap-1">Go SDK <ArrowRight className="w-3 h-3" /></a>
          </div>
        </div>
