          ...
          {vol > 500000 && (
            <div className="bg-warning/10 border border-warning/25 rounded-md py-3 px-4 flex items-center gap-2">
              ...
              <span className="text-[13px] text-warning">
                Your volume exceeds the Growth plan quota. <a href="mailto:enterprise@solidus.network" className="underline hover:text-warning/80">Contact Enterprise Sales →</a>
              </span>
            </div>
          )}
        </div>
