...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full flex flex-col">
      {/* Sandbox Banner */}
      {isSandbox && <div className="w-full bg-warning/10 border-b border-warning/20 py-2.5 px-6 flex items-center shrink-0">
        <div className="flex items-center gap-2">
      ...
      <div className="p-8 pb-12 max-w-[1200px] mx-auto w-full flex flex-col">
        ...
        <div className="bg-[#FF9500]/10 border border-[#FF9500]/25 rounded-md px-4 py-2 mt-4 flex items-center gap-2">
          <span className="text-[12px] font-medium text-[#FF9500]">Preview — volume chart, live stream, and webhook delivery show simulated data</span>
        </div>
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2">
                ...
                <div className="h-5 px-2 rounded-full bg-warning/15 border border-warning/30 flex items-center justify-center">
                  <span className="text-[11px] font-semibold text-warning">{stats?.pending ?? 0}</span>
                </div>
              </div>
