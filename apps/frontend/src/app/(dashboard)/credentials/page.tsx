...
export default function CredentialsPage() {
  ...
  return (
    <div className="p-8 flex flex-col gap-6 max-w-[1400px] mx-auto w-full animate-in fade-in duration-500">
      {/* Preview Banner */}
      <div className="bg-[#FF9500]/10 border border-[#FF9500]/20 text-[#FF9500] text-[13px] rounded-[8px] p-3">
        Credential management shown as preview — real data from chain coming with SDK integration
      </div>
