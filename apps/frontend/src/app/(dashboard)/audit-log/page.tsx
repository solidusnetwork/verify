      ...
      <div className="fixed right-0 top-0 bottom-0 z-50 w-[480px] bg-surface border-l border-border flex flex-col shadow-elevated overflow-y-auto">
        ...
        {event.blockHash && (
          <div className="px-6 py-4 border-b border-border">
            ...
            <a
              href={`https://explorer.solidus.network/tx/${event.blockHash}`}
              target="_blank"
  ...
  return (
    <div className="p-8 flex flex-col gap-6 max-w-[1400px] mx-auto w-full animate-in fade-in duration-500">
      ...
      <div className="bg-success/5 border border-success/20 rounded-lg px-5 py-3 flex items-center justify-between">
        ...
        <a href="https://explorer.solidus.network" target="_blank" rel="noopener noreferrer" className="text-[13px] text-cta hover:underline flex items-center gap-1 shrink-0">
          View on Explorer <ExternalLink className="w-3 h-3" />
        </a>
      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-0 px-4">
                        {e.blockHash ? (
                          <a
                            href={`https://explorer.solidus.network/tx/${e.blockHash}`}
                            target="_blank"
                            rel="noopener noreferrer"
