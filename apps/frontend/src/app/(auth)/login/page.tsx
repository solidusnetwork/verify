...
export default function LoginPage() {
  ...
  const [error, setError] = useState(() => {
    ...
    if (urlError === 'google_auth_failed') return 'Google sign-in failed. Please try again.'
    if (urlError === 'github_auth_failed') return 'GitHub sign-in failed. Please try again.'
    return ''
  })
              ...
              <form onSubmit={handleLogin} className="w-full bg-surface rounded-xl border border-border p-6 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    required
                    className="h-12 px-3 bg-elevated border border-border rounded-md text-base text-white placeholder:text-text-disabled outline-none focus:border-cta transition-colors"
                  />
                </div>
                <div className="flex flex-col gap-1.5">
                ...
                <button type="submit" disabled={loading} className="h-12 w-full bg-cta hover:bg-cta/90 text-white text-[16px] font-semibold rounded-md transition-colors shadow-[0_0_12px_rgba(0,102,255,0.4)] disabled:opacity-60 disabled:cursor-not-allowed mt-1">
                ...
                <button
                  ...
                  className="h-12 w-full bg-transparent border border-border hover:bg-elevated rounded-lg flex items-center justify-center gap-3 transition-colors disabled:opacity-60"
                >
                ...
                <a
                  href="/v1/auth/github"
                  className="h-12 w-full bg-[#24292e] hover:bg-[#2f363d] border border-[#30363d] rounded-lg flex items-center justify-center gap-3 transition-colors"
                >
                  <svg viewBox="0 0 24 24" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-[13px] text-white font-medium">Continue with GitHub</span>
                </a>
              </form>
            ...
            <>
              ...
              <form onSubmit={handleMfaSubmit} className="w-full bg-surface rounded-xl border border-border p-6 flex flex-col gap-5">
                ...
                <button
                  ...
                  className="h-12 w-full bg-cta hover:bg-cta/90 text-white text-[16px] font-semibold rounded-md transition-colors shadow-[0_0_12px_rgba(0,102,255,0.4)] disabled:opacity-60 disabled:cursor-not-allowed"
                >
